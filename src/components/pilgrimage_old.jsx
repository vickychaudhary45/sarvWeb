...
import grid1 from '../assets/img/pilgri_listing/ked-card.jpg'
        ...
        <div className="holi_list">
            <div className="pil-search">
                ...
                <div className="pil-search-op">
                    <div className="input-pil-search-op">
                        ...
                        <input type="text" name="seach-pil" id="search" placeholder='Enter Location or Select from list'/>
            ...
            <div className="hl-body-section">
                <div className="hl-sidebar" id={isTransformed?'hl-filter':'on-hl-filter'}>
                    ...
                    <li> <input type="checkbox" name="l-h" id="l-h" />
                        <label htmlFor='l-h'>Varanashi</label> </li>
                    <li> <input type="checkbox" name="l-h" id="l-h" />
                        <label htmlFor='l-h'>Haridwar
</label> </li>
                      <li> <input type="checkbox" name="l-h" id="l-h" />
                        <label htmlFor='l-h'>Kedarnath</label> </li>
                        <li> <input type="checkbox" name="l-h" id="l-h" />
                        <label htmlFor='l-h'>Rameshwaram</label> </li>
                        <li> <input type="checkbox" name="l-h" id="l-h" />
                        <label htmlFor='l-h'>Hot Deals</label> </li>
                    </div>
                </div>
                <div className="pil-main-body">
                        <i className="filter-small"  onClick={toggleChange}><BsFilterSquareFill /></i>
                        <h1 id="pil-total-card">269 Pilgrimage <span>in India</span></h1>
                          ...
                          {currentItems.map((value,index) =>(
                            <div className="pil-card">
                              ...
                              <div className="card-t-info">
                                     <h3>Water skiing</h3>
                                     <div className="pil-card-ad">
                                      <div className="pil-area">
                                      <i><IoLocationOutline /></i>
                                     <p>Manali</p>
                                      </div>
                                      <div className="pil-duration">
